      ...
      <div class="row">
        <div class="col-lg-8 offset-lg-2">
          <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
            ...
            <p>If you need the greatest collection of HTML templates for your business, please visit <a rel="nofollow" href="#" target="_blank">TooCSS</a> Blog. If you need to have a contact form PHP script, go to <a href="https://templatemo.com/contact" target="_parent">our contact page</a> for more information.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="service-item third-service">
            ...
            <p>If this template is beneficial for your work, please support us <a rel="nofollow" href="#" target="_blank">a little via PayPal</a>. Thank you.</p>
            <div class="text-button">
              <a href="#">Read More <i class="fa fa-arrow-right"></i></a>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="pricing-item-regular">
            <span class="price"><i class="fa-solid fa-rupee-sign"></i> 12</span>
        ...
        <div class="col-lg-4">
          <div class="pricing-item-pro">
            <span class="price"><i class="fa-solid fa-rupee-sign"></i> 25</span>
        ...
        <div class="col-lg-4">
          <div class="pricing-item-regular">
            <span class="price"><i class="fa-solid fa-rupee-sign"></i> 66</span>
